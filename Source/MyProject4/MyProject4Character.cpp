...
void AMyProject4Character::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	// Bind fire event
	PlayerInputComponent->BindAction("PrimaryAction", IE_Pressed, this, &AMyProject4Character::OnPrimaryAction);
...
void AMyProject4Character::OnPrimaryAction()
{
	// Trigger the OnItemUsed Event
	OnUseItem.Broadcast();
}

void AMyProject4Character::BeginTouch(const ETouchIndex::Type FingerIndex, const FVector Location)
{
...
void AMyProject4Character::EndTouch(const ETouchIndex::Type FingerIndex, const FVector Location)
{
...
bool AMyProject4Character::EnableTouchscreenMovement(class UInputComponent* PlayerInputComponent)
{
	if (FPlatformMisc::SupportsTouchInput() || GetDefault<UInputSettings>()->bUseMouseForTouch)
	{
		PlayerInputComponent->BindTouch(EInputEvent::IE_Pressed, this, &AMyProject4Character::BeginTouch);
		PlayerInputComponent->BindTouch(EInputEvent::IE_Released, this, &AMyProject4Character::EndTouch);
